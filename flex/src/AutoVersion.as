package
{
	...
	public class AutoVersion
	{
		...
		// different machine.
		// ========================================================================
		[Embed(mimeType="application/octet-stream", source="/Users/nick/Library/Preferences/Macromedia/Flash Player/#SharedObjects/6EMKFUSB/localhost/AutoVersion.sol")]
